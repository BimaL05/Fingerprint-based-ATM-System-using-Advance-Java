...
<body>
   ...
   // Integer availNumInt = (Integer) session.getAttribute("avail");
    //int avail = availNumInt.intValue();
    %>
    
    <nav class="navbar navbar-expand-lg navbar-dark text-light nav-bk">
        <ul class="navbar-nav mr-auto">
        <li class="nav-item"><a class="nav-link text-light disabled mr-5">e-Bank</a></li>
    ...
    <h3 class="action">
        <span style="font-family: 'Roboto Slab', serif">Balance Information</span>
    </h3>
    ...
    <div class="main">
        ...
        <p>Available Balance: Rs. <%= session.getAttribute("avail") %></p>
    </div>
